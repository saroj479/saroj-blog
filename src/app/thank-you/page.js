...
export default function ThankYou() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-yellow-100 to-yellow-300 p-4">
      ...
      <p className="mb-4 max-w-md text-center text-lg text-gray-700">Your support means a lot. We appreciate your generosity!<br/>You will be redirected to the homepage in a moment.</p>
      <div className="text-sm text-gray-500">If you are not redirected, <button className="text-blue-600 underline" onClick={() => router.push("/")}>click here</button>.</div>
    </div>
  );
} 